...
try {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        // SQL query to select data from the tables filtered by the logged-in user
                $sql = "SELECT services.service_id,services.service_name, services.description, vendor_services.price, vendor_services.rating, vendors.user_id
                FROM services
...
.material-symbols-outlined {
    ...
    <tbody>
        <?php foreach ($rows as $row): ?>
            <tr data-booking-id="<?php echo $row['service_id']; ?>">
